    ...
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 section-container text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1
            className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light text-brand-900 leading-[0.95] mb-6 animate-fade-in-up"
            style={{ animationDelay: '0.2s', animationFillMode: 'backwards' }}
          >
            Rebalance
            <span className="block text-brand-600 italic font-light text-[0.55em] mt-2">
              Reflexology
            </span>
          </h1>
